...
<head>
	...
	<title>Work-Force | Página de Contacto</title>
						...
						foreach ($results as $row) { ?>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4"><!-- infobox -->
								<div class="info-box bgwhite shadow-1 clearfix">
									<div class="info-icon">
									<a href="https://wa.me/524642145958?text=¡Hola! Estoy interesado(a) en saber como puedo ingresar como trabajador, espero me ayuden" target="_blank">

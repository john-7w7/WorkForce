...
$sql="insert into tblperson(Category,Name,Picture,MobileNumber,Address,City,Calificacion)values(:cat,:name,:pics,:mobilenumber,:address,:city,:Calificacion)";
 ...
 <?php } ?> 
                  ...
                  <div class="form-group">
                    ...
                    <select name="Calificacion" class="form-control" id="Calificacion">
                      <option value="value" selected>Escoge una Calificacion</option>
                      <option value="⭐">⭐</option>
                      <option value="⭐⭐">⭐⭐</option>
                      <option value="⭐⭐⭐">⭐⭐⭐</option>
                      <option value="⭐⭐⭐⭐">⭐⭐⭐⭐</option>

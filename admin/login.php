...
<head>
  ...
  <title>Sistema de gestión de motores de búsqueda de servicios locales | Acceso</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php"><b>Administrador</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
        <center><a href="forgot-password.php">Olvidé mi contraseña</a></center>
        </p>

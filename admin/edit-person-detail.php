...
$sql="update tblperson set Category=:cat,Name=:name,MobileNumber=:mobilenumber,Address=:address,City=:city,especialidad=:especialidad where ID=:eid";
...
<head>
  ...
  <title>Work-Force | Actualizar Detalle de Persona</title>
...
<option value="<?php echo htmlentities($row1->Category);?>"><?php echo htmlentities($row1->Category);?></option>
 <?php } ?> 
                  ...
                  <div class="form-group">
                    ...
                    <select name="Calificacion" class="form-control" id="Calificacion" value="<?php echo htmlentities($row->Calificacion);?>" required>
                      <option value="value1" selected>Escoge una Calificacion</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="especialidad" value="<?php echo htmlentities($row->especialidad);?>" required>
                  </div>
                </div>
              <?php $cnt=$cnt+1;}} ?> 

...
<body>
	...
	<div class="theme-wrap clearfix">
		...
		<div class="page-title-wrap bgorange-1 padding-top-30 padding-bottom-30"><!-- section title -->
			<h4 class="white">Detalle de la persona</h4>
									...
									<div class="single-listing-wrap">
										...
										<div class="listing-contact-detail-wrap">
											...
											<div class="listing-contact-section-table">
												...
												<div class="listing-contact-table-field">
													<ul>
														<li class="info">Numero de telefono</li>
														<li class="details">
															<a href="" style="text-align: left;"><?php echo $row->MobileNumber; ?></a>
														</li>
													</ul>
												</div>
												<div class="listing-contact-table-field">
													<ul>
														<li class="info">Direccion</li>
														<li class="details">
									...
									<div class="sidebar-widget shadow-1">
										...
										<div class="sidebar-widget-content advertise  clearfix">
											<div class="sidebar-image-ads">
												<img src="admin/images/<?php echo $row->Picture; ?>" height="195" width="300"
													alt="listing item" />
											</div>
										</div>
									</div>
